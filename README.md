About ssipfootprint-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ssipfootprint-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14255&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ssipfootprint-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ssipfootprint` can be installed with `conda`:
...
```
mamba install ssipfootprint
```

It is possible to list all of the versions of `ssipfootprint` available on your platform with `conda`:
...
```
mamba search ssipfootprint --channel conda-forge
```
...
mamba repoquery search ssipfootprint --channel conda-forge

# List packages depending on `ssipfootprint`:
mamba repoquery whoneeds ssipfootprint --channel conda-forge

# List dependencies of `ssipfootprint`:
mamba repoquery depends ssipfootprint --channel conda-forge
```
